...
switches = []
sw1 = FSR_FTN_14(u'EL:TA:KO:ID', 'my/mqtt/topic', [0x00, 0x00, 0x10, 0x13])
switches.append(sw1)
sw2 = FSR_FTN_14(u'EL:TA:KO:ID', 'my/mqtt/topic', [0x00, 0x00, 0x10, 0x14])
switches.append(sw2)
sw3 = FSR_FTN_14(u'EL:TA:KO:ID', 'my/mqtt/topic', [0x00, 0x00, 0x10, 0x03])
switches.append(sw3)
sw4 = FSR_FTN_14(u'EL:TA:KO:ID', 'my/mqtt/topic', [0x00, 0x00, 0x10, 0x04])
switches.append(sw4)
